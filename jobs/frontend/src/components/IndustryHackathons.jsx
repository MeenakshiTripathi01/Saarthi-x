            ...
            {displayHackathons.length === 0 ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredHackathons.map((hackathon) => {
                  ...
                  <div
                    key={hackathon.id}
                    className={`bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all duration-200 group ${
                      hasResultsPublished 
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          <h3 className="font-bold text-lg text-gray-900 line-clamp-2 group-hover:text-purple-600 transition-colors flex-1">
                            {hackathon.title}
                          </h3>
                          {hasResultsPublished && (
                    ...
                    {(hackathon.firstPrize || hackathon.secondPrize || hackathon.thirdPrize || hackathon.prize) && (
                      <div className="mb-3 p-2 bg-purple-50 rounded-lg border border-purple-200">
                        ...
                        {hackathon.firstPrize && (
                          <p className="text-xs text-purple-700 mb-0.5">
            ...
            <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-gray-100 animate-slideIn my-8">
              ...
              <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {selectedHackathon.phases.map((phase, index) => (
                        <div key={phase.id || index} className="border-2 border-gray-200 rounded-lg p-5 bg-white shadow-sm">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1">
                              <h4 className="font-bold text-lg text-gray-900 mb-2">Phase {index + 1}: {phase.name || `Phase ${index + 1}`}</h4>
                          ...
                          <div className="mb-3 p-2 bg-red-50 border border-red-200 rounded-lg">
                            <p className="text-xs font-semibold text-red-900 mb-1">⏰ Submission Deadline</p>
                          ...
                          {phase.uploadFormat && (
                            <div className="mb-3 p-2 bg-gray-50 border border-gray-200 rounded-lg">
                              ...
                              <p className="text-sm text-gray-800 font-medium">{phase.uploadFormat}</p>
                            </div>
                          )}
                          ...
                          {(phase.phaseMode === 'Offline' || phase.phaseMode === 'Hybrid') && (phase.phaseVenueLocation || phase.phaseReportingTime) && (
                            <div className="mt-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-lg">
                              ...
                              {phase.phaseVenueLocation && (
                                <div className="mb-3">
                                  <p className="text-xs font-semibold text-blue-800 mb-1">📍 Venue Location</p>
                                  <p className="text-sm text-gray-800 font-medium pl-4">{phase.phaseVenueLocation}</p>
                                </div>
                              )}
                              {phase.phaseReportingTime && (
                                <div>
                                  <p className="text-xs font-semibold text-blue-800 mb-1">⏰ Reporting Date & Time</p>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  {(selectedHackathon.firstPrize || selectedHackathon.secondPrize || selectedHackathon.thirdPrize || selectedHackathon.prize) && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <h3 className="text-sm font-bold text-yellow-900 mb-2">🏆 Prize Pool</h3>
                      {selectedHackathon.firstPrize && (
                        <p className="text-gray-700 text-sm mb-1">
                          <span className="font-semibold">1st Place:</span> {selectedHackathon.firstPrize}
                        </p>
                      )}
                      {selectedHackathon.secondPrize && (
                        <p className="text-gray-700 text-sm mb-1">
                          <span className="font-semibold">2nd Place:</span> {selectedHackathon.secondPrize}
                        </p>
                      )}
                      {selectedHackathon.thirdPrize && (
                        <p className="text-gray-700 text-sm mb-1">
                          <span className="font-semibold">3rd Place:</span> {selectedHackathon.thirdPrize}
                        </p>
                      )}
                      {!selectedHackathon.firstPrize && !selectedHackathon.secondPrize && !selectedHackathon.thirdPrize && selectedHackathon.prize && (
